document.addEventListener("DOMContentLoaded", () => {
    ...
    // Create Note Element Function with improved code visibility
    function createNoteElement(note) {
        ...
        // Apply different styling for code preview
    ...
    // Show Note Details Function with improved code visibility
    function showNoteDetails(note) {
        ...
        // Highlight code if it's a code note
    ...
    function displayFilteredNotes(filteredNotes) {
        ...
        // Highlight code in filtered results
        if (window.Prism) {
            Prism.highlightAll();
        }
    }
